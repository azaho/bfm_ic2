...
weight_decays=(0.0)
batch_sizes=(100)
electrode_embedding_types=("noisy_coordinate")
coordinate_noise_stds=(0.0 0.001 0.005 0.01)
random_strings=("EECN_1" "EECN_2" "EECN_3")
...
ecn_idx1=$(( (idx1 / (n_l * n_d * n_lr * n_ws * n_bs * n_rs * n_ee)) % n_ecns ))
...
ecn_idx2=$(( (idx2 / (n_l * n_d * n_lr * n_ws * n_bs * n_rs * n_ee)) % n_ecns ))
...
ECN1=${coordinate_noise_stds[$ecn_idx1]}
...
ECN2=${coordinate_noise_stds[$ecn_idx2]}

echo "Job 1 - LR: $LR1, D_MODEL: $D_MODEL1, N_LAYERS: $N_LAYERS1, WS: $WS1, BS: $BS1, RS: $RS1, EE: $EE1, ECN: $ECN1"
echo "Job 2 - LR: $LR2, D_MODEL: $D_MODEL2, N_LAYERS: $N_LAYERS2, WS: $WS2, BS: $BS2, RS: $RS2, EE: $EE2, ECN: $ECN2"

python -u train_model.py --learning_rate $LR1 --d_model $D_MODEL1 --n_layers_electrode $N_LAYERS1 --n_layers_time $N_LAYERS1 --weight_decay $WS1 --batch_size $BS1 --random_string $RS1 --electrode_embedding_type $EE1 --electrode_embedding_coordinate_noise_std $ECN1 &
python -u train_model.py --learning_rate $LR2 --d_model $D_MODEL2 --n_layers_electrode $N_LAYERS2 --n_layers_time $N_LAYERS2 --weight_decay $WS2 --batch_size $BS2 --random_string $RS2 --electrode_embedding_type $EE2 --electrode_embedding_coordinate_noise_std $ECN2 &
wait